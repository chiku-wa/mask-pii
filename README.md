...
![mask-piiの入力、ローカル検出、出力のしくみとメリット](docs/images/README/mask-pii-overview.png)
...
一般的な部門名（営業部、情報システム部、A部門、経理課、カスタマーサポートチームなど）はCSVなしでもマスクされます。
会社独自の組織名や略称も確実にマスクしたい場合は、1列目に部門名を1行1件で記載します（ヘッダー行は不要）。
